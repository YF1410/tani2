...
void MyGame::Initialize()
{
	...
	//BGM(0～9)
	Audio::GetInstance()->LoadWave(0, "Resources/Audio/BGM/select_01.wav");   //タイトル
	Audio::GetInstance()->LoadWave(1, "Resources/Audio/BGM/select_01.wav");   //セレクトシーン
	Audio::GetInstance()->LoadWave(2, "Resources/Audio/BGM/game_01.wav");     //ステージ0
	...
	//SE(10～16)
	Audio::GetInstance()->LoadWave(10, "Resources/Audio/SE/damage_01.wav");     //ブースト状態
	...
	Audio::GetInstance()->LoadWave(16, "Resources/Audio/SE/wall_01.wav");     //壁に当たった時
